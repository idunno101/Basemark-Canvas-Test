...
!(function (e, t) {
  ...
  function q(e, t, n) {
    ...
    n.queue ||
      ...
      1 === e.nodeType &&
        ...
        (l = Z.css(e, "display")),
        (c = "none" === l ? me.get(e, "olddisplay") || b(e.nodeName) : l),
        "inline" === c &&
          "none" === Z.css(e, "float") &&
  ...
  (Z.fn.ready = function (e) {
    ...
    Z.ready.promise();
  var ve = (Z.access = function (e, t, n, r, i, o, s) {
    var a = 0,
      u = e.length,
      l = null == n;
    if ("object" === Z.type(n)) {
    ...
    Z.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = ye.get(o)), 1 === o.nodeType && !me.get(o, "hasDataAttrs"))
          ) {
            for (n = s.length; n--; )
              s[n] &&
                ((r = s[n].name),
        ...
        for (
          ...
          (a = je.exec(t[l]) || []),
            ...
            d &&
              ...
              f.add &&
                (f.add.call(e, c), c.handler.uid || (c.handler.uid = n.uid)),
  ...
  (Me.optgroup = Me.option),
    ...
    Z.extend({
      clone: function (e, t, n) {
        ...
        return (
          (s = m(a, "script")), s.length > 0 && g(s, !u && m(e, "script")), a
        );
      },
    ...
    Z.fn.extend({
      ...
      domManip: function (e, t) {
        ...
        if (
          ...
          for (i = Z.map(m(n, "script"), d), o = i.length; l > u; u++)
            (s = n),
              u !== f &&
                ((s = Z.clone(s, !0, !0)), o && Z.merge(i, m(s, "script"))),
              t.call(this[u], s, u);
          if (o)
            for (
      ...
      Z.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          ...
          return N(
            e,
            n,
            r ? k(e, t, r, "border-box" === Z.css(e, "boxSizing", !1, i), i) : 0
          );
        },
      };
    }),
          ...
          u
            ? (f.ifModified &&
              ...
              204 === e || "HEAD" === f.type
                ...
                : 304 === e
                ? (T = "notmodified")
                : ((T = y.state), (c = y.data), (m = y.error), (u = !m)))
